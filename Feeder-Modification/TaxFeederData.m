...
elseif (strcmp(file_to_extract,'R1-12.47-1.glm')~=0)
    ...
    data.avg_house = 2700;  % SJCR edit on 1/25/18 was at 4000 
    data.avg_commercial = 10000;  % SJCR edit , was at 20000
...
elseif (strcmp(file_to_extract,'R2-12.47-2.glm')~=0)    
    ...
    data.avg_house = 5000;  % formerly was 7500
    data.avg_commercial = 10000; % formerly was 25000
...
elseif (strcmp(file_to_extract,'R3-12.47-3.glm')~=0)
    ...
    data.avg_house = 4700;  % formerly 7000
    data.avg_commercial = 10000; % formerly 15000;
...
elseif (strcmp(file_to_extract,'R4-12.47-1.glm')~=0)    
    ...
    data.avg_house = 6000;  % formerly 9000
    data.avg_commercial = 20000;  % formerly 30000
...
elseif (strcmp(file_to_extract,'R5-25.00-1.glm')~=0)    
    ...
    data.avg_house = 4500;  % formerly 3000
    data.avg_commercial = 20000;
