...
int transformer_configuration::init(OBJECT *parent)
{
	...
	{
		//SJC edit - removed this piece of code, which assumes full_load_loss is in per unit impedance
		// because in the transformer.cpp file full_load_loss is in per unit power! 
