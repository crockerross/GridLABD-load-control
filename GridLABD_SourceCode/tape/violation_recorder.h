...
//	quickobjlist *tplxl_phase_c_obj_list;
	...
	vobjlist *tplx_mtr_comm_obj_list;
	vobjlist *tplx_mtr_res_obj_list;
	...
	uniqueList *tplx_meter_comm_list_v2;
	uniqueList *tplx_meter_res_list_v2;
	uniqueList *comm_meter_list_v2;
	uniqueList *node_list_v3;
	uniqueList *tplx_node_list_v3;
	uniqueList *tplx_meter_list_v3;
	uniqueList *tplx_meter_comm_list_v3;
	uniqueList *tplx_meter_res_list_v3;
