...
public:
	...
	double house_content_heat_transfer_coeff;	///< mass UAh
	...
	double hvac_onAndAvailable;		// hvac is on, zero if hvac is NOT available for switching,one otherwise
	double hvac_offAndAvailable;		// hvac is off, zero if hvac is NOT available for switching,one otherwise
	double locked_out;		// hvac can't switch because of a lockout time
	...
	double system_rated_capacity_lastOn; ///< rated capacity of the cooling system when it was last on
